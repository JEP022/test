...
if (!isset( $_POST['submit'] )) {
    ...
    $sql = "insert into users (ID, firstname, surname, email, password) values ('".$_POST['ID']."','".$_POST['fname']."','".$_POST['sname']."','".$_POST['email']."','".$_POST['pass']."')";
...
<form action="newuser.php" method="post" >
	ID: <br><input	type="text" id="ID" name="ID"/><br>
